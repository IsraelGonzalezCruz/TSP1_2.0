...
public class AIBehavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Deteccion de enemigos en posición de jugador
    ...
    //Método para llevar a player a la entrada
    void TeleportPlayerToEntrance()
    {
        ...
        Debug.Log("Player teleported to "+ entrancePos);   
    }

    //Método para posicionar a los enenmigos
    ...
    void RelocateAllNPC()
    {
        ...
        {
            agent.enabled = false;
            //  agent.transform.position = GetRandomPositionOnNavMesh();
            agent.enabled = true;
        }
    }
    ...
    //Método para ubicar los objetos enemigos
